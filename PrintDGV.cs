...
namespace AnalisardorCartao
{
    public class PrintDGV
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1, String titulo)
        {
            ...
            try
            {
                ...
                printDoc.PrinterSettings = prDialog.PrinterSettings;
                printDoc.DefaultPageSettings.Landscape = true;
                printDoc.DefaultPageSettings.Margins.Top = 40;
                printDoc.DefaultPageSettings.Margins.Bottom = 40;
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            foreach (DataGridViewColumn GridCol in dgv.Columns)
                            {
                                ...
                                if (GridCol.InheritedStyle.Alignment == DataGridViewContentAlignment.MiddleRight)
                                {
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                            ...
                            if (Cel.InheritedStyle.Alignment == DataGridViewContentAlignment.MiddleRight)
                            {
                                StrFormat.Alignment = StringAlignment.Far;
                            }
                            else
